...
import 'package:api_call/api_app/core/pretty_printer.dart';
import 'package:api_call/api_app/data/remote/remote_routes/app_remote_routes.dart';
import 'package:api_call/api_app/presentation/routes/LocalStorageNames.dart';
...
class ApiProvider {
  ...
  addToken() {
    ...
    String? accesstoken = getstorage.read(LocalStorageKeys.accessTokenKEY);
    String? refreshtoken = getstorage.read(LocalStorageKeys.accessTokenKEY);
    if (accesstoken != null) {
